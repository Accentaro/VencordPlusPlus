...
import { BackupRestoreIcon, CloudIcon, LogIcon, MainSettingsIcon, PaintbrushIcon, PatchHelperIcon, PluginsIcon, UpdaterIcon } from "@components/Icons"; // missing PlaceholderIcon, VesktopSettingsIcon
import {
    BackupAndRestoreTab,
    ChangelogTab,
    CloudTab,
...
const settingsSectionMap: [string, string][] = [
	...
	/*
		Custom Sections (TODO: Implement these into the respective plugins)
	*/
